...
public class YWVideoDto {
    ...
    public YWVideoDto(int videoIdx, String title, String titleLink, int titleSize, int videoLoop, int slIdx, String videoUrl, int colorIdx) {
