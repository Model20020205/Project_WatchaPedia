...
import dto.YWManyFieldDto;
import dto.YWFieldDto;

public class YWManyFieldDao {

    public YWManyFieldDto getManyField(int mfIdx) throws Exception {
        ...
        YWManyFieldDto manyField = null;
        if (rs.next()) {
            manyField = new YWManyFieldDto(
                rs.getString("title"),
    ...
    public List<YWFieldDto> getField(int mfIdx, int sunseo) throws Exception {
        Connection conn = YWJdbcCommon.getConnection();
        ...
        List<YWFieldDto> fields = new ArrayList<>();
        while (rs.next()) {
            YWFieldDto field = new YWFieldDto(
                rs.getInt("sl_idx"),
                rs.getString("title"),
                rs.getString("title_link"),
