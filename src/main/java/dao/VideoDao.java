...
public class VideoDao {
    ...
    public VideoDto getVideo(int videoIdx) throws Exception {
        ...
        try (Connection con = getConnection();
            ...
            try (ResultSet rs = ps.executeQuery()) {
                if (rs.next()) {
                    return new VideoDto(videoIdx, rs.getString("title"), rs.getString("title_link"),
    ...
    public void updateVideo(VideoDto dto) throws Exception {
    ...
    public void insertVideo(VideoDto dto) throws Exception {
