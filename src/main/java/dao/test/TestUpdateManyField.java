...
public class TestUpdateManyField {
    public static void main(String[] args) throws Exception {
        ...
        dao.updateManyField(mfIdx, title, titleLink, titleSize, width, ratio, lineup, background, buttonLabel, buttonLink);

        System.out.println("여러 열이 성공적으로 업데이트되었습니다.");
        sc.close();
    }
}