...
public class TestUpdateCollectionList {
    public static void main(String[] args) throws Exception {
        ...
        dao.updateCollectionList(clIdx, title, link, titleSize, ratio, numberOfField, allview);
        
        System.out.println("컬렉션 리스트가 성공적으로 업데이트되었습니다.");
        sc.close();
    }
}