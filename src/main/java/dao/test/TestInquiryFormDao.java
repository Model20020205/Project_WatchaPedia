...
import dao.InquiryFormDao;
import dto.InquiryFormDto;

public class TestInquiryFormDao {
    public static void main(String[] args) throws Exception {
        InquiryFormDao dao = new InquiryFormDao();

        // Test getInquiryForm
        InquiryFormDto inquiryForm = dao.getInquiryForm(1);
        if (inquiryForm != null) {
        ...
        InquiryFormDto updateDto = new InquiryFormDto(1, "제목", "제목링크", 1, 0);
        ...
        InquiryFormDto insertDto = new InquiryFormDto(0, "제목", "제목링크", 1, 0);
