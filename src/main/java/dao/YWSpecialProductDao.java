...
import dto.YWSpecialProductDto;

public class YWSpecialProductDao {
	 public YWSpecialProductDto getSpecialProduct(int storeIdx, int specialProductIdx) throws Exception {
	        ...
	        YWSpecialProductDto specialProduct = null;
	        if (rs.next()) {
	            specialProduct = new YWSpecialProductDto(
	    ...
	    public List<YWSpecialProductDetailsDto> getSpecialProductDetails(int specialProductIdx, int storeIdx) throws Exception {
	        Connection conn = YWJdbcCommon.getConnection();
	        ...
	        List<YWSpecialProductDetailsDto> detailsList = new ArrayList<>();
	        while (rs.next()) {
	            YWSpecialProductDetailsDto details = new YWSpecialProductDetailsDto(
	                rs.getString("제품명"),
	                rs.getInt("제품사진"),
	                rs.getInt("가격"),
