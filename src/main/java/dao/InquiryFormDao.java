...
import dto.InquiryFormDto;

import java.sql.*;

public class InquiryFormDao {
    private Connection getConnection() throws Exception {
    	return JdbcCommon.getConnection();
    }

    public InquiryFormDto getInquiryForm(int ifIdx) throws Exception {
        ...
        try (Connection con = getConnection();
            ...
            try (ResultSet rs = ps.executeQuery()) {
                if (rs.next()) {
                    return new InquiryFormDto(ifIdx, rs.getString("title"), rs.getString("title_link"),
    ...
    public void updateInquiryForm(InquiryFormDto dto) throws Exception {
    ...
    public void insertInquiryForm(InquiryFormDto dto) throws Exception {
