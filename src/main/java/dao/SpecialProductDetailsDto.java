...
public class SpecialProductDetailsDto {
    ...
    public SpecialProductDetailsDto(String pdName, int slIdx, int price, String lop1Type, String lop2Type, String lop3Type, int amount) {
        this.pdName = pdName;
        this.slIdx = slIdx;
        this.price = price;
