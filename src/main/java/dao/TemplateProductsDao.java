...
public class TemplateProductsDao {
    ...
    public TemplateProductsDto getTemplateProducts(int tpIdx, int storeIdx) throws Exception {
    ...
    public void updateTemplateProducts(TemplateProductsDto dto) throws Exception {
    ...
    // New Methods
    public ProductDetailsDto getProductDetails(int tpIdx, int storeIdx) throws Exception {
    ...
    public ReducerowDto getReducerow(int tpIdx) throws Exception {
        ...
        try (Connection con = getConnection();
            ...
            try (ResultSet rs = ps.executeQuery()) {
                if (rs.next()) {
                    ReducerowDto dto = new ReducerowDto();
