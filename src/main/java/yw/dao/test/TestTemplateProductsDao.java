...
import dao.YWTemplateProductsDao;
...
public class TestTemplateProductsDao {
    ...
    private YWTemplateProductsDao dao = new YWTemplateProductsDao();
    ...
    public void testGetTemplateProducts() throws Exception {
    	YWTemplateProductsDto dto = dao.getTemplateProducts(1, 1); // Assuming tpIdx is 1 and storeIdx is 1
        if (dto != null) {
    ...
    public void testGetProductDetails() throws Exception {
    	YWProductDetailsDto dto = dao.getProductDetails(1, 1); // Assuming tpIdx is 1 and storeIdx is 1
        if (dto != null) {
    ...
    public void testGetReducerow() throws Exception {
    	YWReducerowDto dto = dao.getReducerow(1); // Assuming tpIdx is 1
        if (dto != null) {
